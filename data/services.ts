...
export const whyChooseSection = {
  kicker: 'Why Choose Our Tutoring Services',
  title: 'A Structured Ecosystem Built Around the <span class="text-gradient-brand">Learner</span>',
  classes: '!px-0 !py-0',
  description:
    'Indian Mentors combines personalised teaching, verified educators, structured academic planning, and technology-enabled monitoring to create a more transparent and supportive tutoring experience.',
  features: [
    {
      iconMdi: 'mdi:account-check-outline',
      title: 'Verified Educators',
      description: 'Carefully screened tutors selected for academic credibility and teaching capability.',
    },
    {
      iconMdi: 'mdi:target',
      title: 'Personalised Learning',
      description: 'Learning strategies designed around each student\'s individual academic needs.',
    },
    {
      iconMdi: 'mdi:book-education-outline',
      title: 'Curriculum Support',
      description: 'Teaching aligned with recognised boards and applicable academic frameworks.',
    },
    {
      iconMdi: 'mdi:chart-line',
      title: 'Progress Monitoring',
      description: 'Structured tracking and communication to help families understand academic progress.',
    },
    {
      iconMdi: 'mdi:home-outline',
      title: 'Multiple Formats',
      description: 'Home, online, shadow, live-in, travel, and specialised tutoring options.',
    },
    {
      iconMdi: 'mdi:clock-outline',
      title: 'Flexible Scheduling',
      description: 'Learning schedules designed around student and family requirements wherever feasible.',
    },
    {
      iconMdi: 'mdi:account-group-outline',
      title: 'Dedicated Support',
      description: 'Academic counsellors and support teams available throughout the tutoring journey.',
    },
    {
      iconMdi: 'mdi:laptop',
      title: 'Technology-Enabled',
      description: 'ERP-supported systems designed for improved coordination and transparency.',
    },
    {
      iconMdi: 'mdi:account-switch-outline',
      title: 'Tutor Replacement Support',
      description: 'Structured assistance when a tutor change is required.',
    },
    {
      iconMdi: 'mdi:shield-check-outline',
      title: 'Safe Learning Environment',
      description: 'Professional, respectful, and student-focused academic interactions.',
    },
    {
      iconMdi: 'mdi:earth',
      title: 'Broad Academic Coverage',
      description: 'Support across school boards, international curricula, and selected specialised requirements.',
    },
    {
      iconMdi: 'mdi:handshake-outline',
      title: 'Parent Partnership',
      description: 'Regular communication and academic coordination to keep families informed.',
    },
  ],
}
