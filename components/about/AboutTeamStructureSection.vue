    ...
    <div class="container-page">
      ...
      <div class="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <article v-for="(unit, i) in aboutTeamStructure.units" :key="unit.title"
          ...
          <span
            class="inline-flex h-11 w-11 items-center justify-center  transition duration-300 group-hover:scale-105 group-hover:text-white group-hover:ring-white/25">
            <Icon :icon="unit.icon" class="h-8 w-8" aria-hidden="true" />
          </span>
