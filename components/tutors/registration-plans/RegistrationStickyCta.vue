...
import { stickyCta } from '~/data/tutor-registration-plans'
...
<template>
  <Transition enter-active-class="transition duration-300 ease-out"
    ...
    <div v-show="visible"
      ...
      role="region" aria-label="Tutor registration plan actions">
