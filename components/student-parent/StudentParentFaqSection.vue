...
import { spFaqs } from '~/data/student-parent'
</script>

<template>
  <section id="faqs" class="relative scroll-mt-28 overflow-hidden bg-white section-py"
    aria-labelledby="sp-faq-heading">
    <div class="container-page">
      <CardHeader heading-id="sp-faq-heading" :badge="spFaqs.badge" :title="spFaqs.title"
        :classes="spFaqs.classes" />

      <div class="mx-auto mt-10 max-w-3xl space-y-3">
        <details v-for="(item, i) in spFaqs.items" :key="item.id"
