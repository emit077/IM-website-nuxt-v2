...
import { insightsFaqSection, insightsFaqs } from '~/data/insights'
</script>

<template>
  <section id="insights-faq" class="relative scroll-mt-20 overflow-hidden bg-white section-py"
    aria-labelledby="insights-faq-heading">
    <div class="container-page">
      <CardHeader heading-id="insights-faq-heading" :badge="insightsFaqSection.kicker" :title="insightsFaqSection.title"
        :classes="insightsFaqSection.classes" />

      <div class="mx-auto mt-10 max-w-3xl space-y-3">
        <details v-for="(item, i) in insightsFaqs" :key="item.id"
