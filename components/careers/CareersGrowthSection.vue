...
<template>
  <section id="career-growth" class="relative scroll-mt-20 overflow-hidden bg-white section-py"
    ...
    <div class="container-page relative">
      <CardHeader heading-id="career-growth-heading" :badge="growthSection.kicker" :title="growthSection.title"
        :description="growthSection.description" :classes="growthSection.classes" />
      ...
      <div class="mt-10 grid grid-cols-1 items-stretch gap-6 lg:mt-12 lg:grid-cols-12 lg:gap-8">
        ...
        <div class="relative order-1 flex lg:order-2 lg:col-span-5" v-motion :initial="{ opacity: 0, y: 16 }"
          ...
          <figure
            ...
            <figcaption class="absolute bottom-0  bg-black/20 shadow-soft backdrop-blur-sm">
              <!-- <p class="text-[11px] font-bold uppercase tracking-[0.14em] text-blue-700">
                {{ growthSection.overlayKicker }}
              </p> -->
              <p class="mt-1.5 font-display text-sm font-bold leading-snug text-white sm:text-base px-4 py-2">
