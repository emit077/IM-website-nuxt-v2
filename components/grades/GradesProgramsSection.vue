  ...
  <div>
    ...
    >
      ...
      <div class="container-page relative">
        ...
        <div
          class="mx-auto mt-8 max-w-3xl rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm sm:p-6"
          v-motion
        ...
        <div
          v-if="stage.streamDetails?.length"
        ...
        >
          ...
          <div class="mt-3 grid gap-3 sm:grid-cols-3">
            <article
              v-for="stream in stage.streamDetails"
              :key="stream.name"
        ...
        <div
          v-if="stage.examGroups?.length"
          class="mx-auto mt-8 max-w-3xl grid gap-3 sm:grid-cols-2"
          v-motion
          :initial="{ opacity: 0, y: 12 }"
          :visibleOnce="{ opacity: 1, y: 0, transition: { delay: 120, duration: 450 } }"
        >
          <div
            v-for="group in stage.examGroups"
            :key="group.label"
        ...
        <div v-if="stage.classes.length" class="mx-auto mt-10 max-w-4xl">
          ...
          <ol class="relative mt-6 space-y-5 sm:space-y-6" role="list">
            ...
            <li
              v-for="(cls, i) in stage.classes"
              :key="cls.id"
              class="relative flex items-start gap-3.5 sm:gap-5"
              v-motion
              ...
              >
                <div class="flex items-start gap-3">
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <div
                      v-if="cls.outcome"
                      class="mt-4 rounded-xl border border-blue-100 bg-blue-50/60 px-3.5 py-3"
                    >
        ...
        <!-- Key features -->
        <div
          v-if="stage.keyFeatures?.length"
          class="mx-auto mt-10 max-w-3xl rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm sm:p-6"
          v-motion
          :initial="{ opacity: 0, y: 12 }"
        ...
        >
          ...
          <ul class="mt-4 grid gap-2 sm:grid-cols-2" role="list">
            <li
              v-for="feature in stage.keyFeatures"
              :key="feature"
              class="flex items-start gap-2.5 text-sm leading-snug text-slate-700"
            >
              <Icon icon="mdi:check-circle" class="mt-0.5 h-4 w-4 shrink-0 text-blue-600" aria-hidden="true" />
