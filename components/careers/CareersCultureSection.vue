...
<template>
  ...
  >
    <div class="container-page relative">
      <CardHeader
        heading-id="work-culture-heading"
        align="left"
        :badge="cultureSection.kicker"
        :title="cultureSection.title"
        :description="cultureSection.subtitle"
        :classes="cultureSection.classes"
      />
      ...
      <div class="mt-8 grid items-center gap-8 lg:mt-10 lg:grid-cols-12 lg:gap-12">
        ...
        >
          <button
            ...
            :aria-label="`View ${cultureSection.featured.caption}`"
            @click="openAt(0)"
          >
            <img
              :src="featuredSrc"
              :alt="cultureSection.featured.alt"
        ...
        >
          ...
          <ul class="mt-6 space-y-3.5" role="list">
            <li
              v-for="item in cultureSection.highlights"
              :key="item.text"
      ...
      <div id="life-at-indian-mentors" class="mt-14 lg:mt-16">
        ...
        <ul class="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3 sm:gap-5" role="list" aria-label="Workplace photo gallery">
          <li
      ...
      <ul class="mt-12 grid grid-cols-1 gap-8 sm:mt-14 sm:grid-cols-3 sm:gap-6 lg:gap-10" role="list">
        <li
          v-for="(item, i) in cultureSection.values"
          :key="item.title"
          class="text-center"
          v-motion
          :initial="{ opacity: 0, y: 12 }"
        ...
        >
          <span
            :class="['mx-auto grid h-12 w-12 place-items-center rounded-2xl ring-1', valueAccent[item.accent]]"
            aria-hidden="true"
          >
