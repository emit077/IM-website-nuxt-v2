...
<template>
  <article :class="[
    ...
    <span v-if="plan.badge"
      class="absolute top-7 -right-1 z-10 inline-flex items-center gap-1.5 rounded-l-md bg-amber-300 px-3 py-1.5 text-[11px] font-extrabold uppercase tracking-wide text-slate-900 shadow-sm">
