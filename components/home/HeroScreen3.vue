...
<template>
  <section class="relative overflow-hidden bg-white bg-right bg-no-repeat" aria-labelledby="hero-screen-3-heading"
    :style="{ backgroundImage: heroContent.backgroundImage }">
    <div class="container-page pb-12 pt-10 lg:pt-16">
      <HeroHeader variant="hero" heading-id="hero-screen-3-heading"
        badge="Safety, Quality &amp; Transparency in Every Session" :title="heroContent.title"
