...
import { careersFaqSection, careersFaqs } from '~/data/careers'
</script>

<template>
  <section id="careers-faq" class="relative scroll-mt-20 overflow-hidden bg-white section-py" aria-labelledby="careers-faq-heading">
    <div class="container-page">
      <CardHeader heading-id="careers-faq-heading" :badge="careersFaqSection.kicker" :title="careersFaqSection.title" :classes="careersFaqSection.classes" />

      <div class="mx-auto mt-10 max-w-3xl space-y-3">
        <details
          v-for="(item, i) in careersFaqs"
          :key="item.id"
