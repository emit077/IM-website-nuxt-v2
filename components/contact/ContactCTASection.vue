...
import { contactGetStarted } from '~/data/contact'
...
<template>
  <section id="book-demo" class="scroll-mt-24 bg-cream-50 py-12 sm:py-16" aria-labelledby="contact-cta-heading">
    <div class="container-page">
      ...
      >
        ...
        <div class="relative mx-auto max-w-2xl">
          ...
          >
            <Icon icon="mdi:rocket-launch-outline" class="h-4 w-4" aria-hidden="true" />
            {{ contactGetStarted.badge }}
          </span>
          ...
          <div class="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:flex-wrap sm:items-center">
            <a
              ...
              @mousemove="cta.primary ? rippleHandler($event) : undefined"
            >
