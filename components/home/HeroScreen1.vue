...
<template>
  <section class="relative overflow-hidden bg-white bg-contain bg-center bg-no-repeat"
    aria-labelledby="hero-screen-1-heading" :style="heroSectionStyle">
    ...
    <div class="container-page pb-12 pt-10 lg:pt-16">
      <CardHeader variant="hero" heading-id="hero-screen-1-heading"
        content-class="!px-0 !py-0 max-w-2xl lg:max-w-[46rem]" badge="India's #1 Verified Tutor Platform"
