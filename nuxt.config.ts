...
export default defineNuxtConfig({
  ...
  nitro: {
    ...
    prerender: {
      crawlLinks: true,
      failOnError: false,
      routes: ['/about', '/academic-coverage', '/grades', '/student-parent', '/student-parent/subscription', '/student-parent/enrollment', '/tutors', '/tutors/registration-plans', '/institutions', '/faq'],
    },
  },
