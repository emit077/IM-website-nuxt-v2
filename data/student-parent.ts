...
export const planPositioning = [
  { iconMdi: 'mdi:medal-outline', name: 'Gold – Smart Start', description: 'Best for basic academic support and homework assistance' },
  ...
  { iconMdi: 'mdi:crown', name: 'Platinum – Premium Excellence', description: 'Perfect for complete academic coverage and exam-focused preparation' },
]
...
export const spNeeds = {
  ...
  items: [
    ...
    { title: 'Learning Gaps', question: 'Which concepts or subjects need extra attention?', iconMdi: 'mdi:puzzle-outline' },
    { title: 'Learning Goals', question: 'Improvement, exam prep, concept building, or advanced learning?', iconMdi: 'mdi:target' },
    { title: 'Learning Pace', question: 'Does the student need extra time to understand and practise?', iconMdi: 'mdi:timer-sand' },
    { title: 'Subject Requirements', question: 'Which subjects require one-to-one support?', iconMdi: 'mdi:book-education-outline' },
    { title: 'Schedule', question: 'What days and timings work best for the family?', iconMdi: 'mdi:calendar-clock-outline' },
    { title: 'Learning Mode', question: 'Is home, online, or hybrid tutoring more suitable?', iconMdi: 'mdi:laptop' },
    { title: 'Learning Environment', question: 'Which setting helps the student stay focused and consistent?', iconMdi: 'mdi:laptop' },
  ],
