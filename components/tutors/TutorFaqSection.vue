...
import { tutorFaqSection, tutorFaqs } from '~/data/tutors'
</script>

<template>
  <section id="tutor-faq" class="relative scroll-mt-28 overflow-hidden section-surface-muted section-py"
    aria-labelledby="tutor-faq-heading">
    <div class="container-page">
      <CardHeader heading-id="tutor-faq-heading" :badge="tutorFaqSection.badge" :title="tutorFaqSection.title"
        :classes="tutorFaqSection.classes" />

      <div class="mx-auto mt-10 max-w-3xl space-y-3">
        <details v-for="(item, i) in tutorFaqs" :key="item.id"
