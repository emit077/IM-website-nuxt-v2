...
<template>
  <section
    id="grades-covered"
    class="relative overflow-x-clip bg-cream-50 py-14 sm:py-16 lg:py-24"
  ...
  >
    ...
    <div class="container-page relative">
      ...
      <!-- Accordion -->
      <div
        class="mx-auto mt-10 max-w-3xl space-y-3 sm:mt-12"
        v-motion
      ...
      >
        ...
        >
          ...
          <button
            ...
            :aria-expanded="activeId === stage.id"
