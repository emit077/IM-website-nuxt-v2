...
export const gradesSection = {
  ...
  stages: [
    ...
    },
    {
      id: 'undergraduate',
      title: 'Undergraduate',
      gradesLabel: 'Bachelor’s & degree programmes',
      tagline: 'Degree-level subject mentoring',
      overview:
        'Undergraduate support for complex subjects, assignments, projects, and structured exam revision.',
      highlights: [
      ...
      chips: ['B.A.', 'B.Sc.', 'B.Com', 'B.Tech', 'Other UG'],
    ...
    },
    {
      id: 'postgraduate',
      title: 'Postgraduate',
      gradesLabel: 'Master’s & advanced study',
      tagline: 'Research & advanced academic support',
      overview:
        'Postgraduate mentoring for advanced topics, research writing, dissertations, and academic projects.',
      highlights: [
        'Advanced subject clarity',
        'Research & writing support',
        'Dissertation guidance',
        'Literature review help',
      ],
      chips: ['M.A.', 'M.Sc.', 'M.Com', 'M.Tech', 'Other PG'],
