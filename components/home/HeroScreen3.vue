...
<template>
  <section class="relative overflow-hidden bg-white  bg-right bg-no-repeat" aria-labelledby="hero-screen-3-heading"
    ...
    <div class="container-page pb-12 pt-10 lg:pt-16">
      <CardHeader variant="hero" heading-id="hero-screen-3-heading"
        content-class="!px-0 !py-0 max-w-2xl lg:max-w-[46rem]"
        tagline="Building Strong Foundations for Lifelong Learning"
        badge="Safety, Quality &amp; Transparency in Every Session" :title="heroTitle" :description="heroDescription">
