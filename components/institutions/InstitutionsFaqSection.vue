...
import { institutionsFaqSection, institutionsFaqs } from '~/data/institutions'
</script>

<template>
  <section id="institutions-faq" class="relative scroll-mt-24 overflow-hidden bg-white section-py"
    aria-labelledby="institutions-faq-heading">
    <div class="container-page">
      <CardHeader heading-id="institutions-faq-heading" :badge="institutionsFaqSection.badge"
        :title="institutionsFaqSection.title" :classes="institutionsFaqSection.classes" />

      <div class="mx-auto mt-10 max-w-3xl space-y-3">
        <details
          v-for="(item, i) in institutionsFaqs"
          :key="item.id"
