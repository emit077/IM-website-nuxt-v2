...
<template>
  <section id="partner-faq" class="relative scroll-mt-20 bg-white section-py"
    aria-labelledby="partner-faq-heading">
    <div class="container-page">
      <CardHeader heading-id="partner-faq-heading" :badge="faqSection.kicker" :title="faqSection.title"
